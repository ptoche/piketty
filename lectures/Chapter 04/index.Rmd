...
n <- nPlot(data = df_4_1, value ~ Year, group = 'variable', color = 'variable', shape = 'variable', type = 'lineChart') 
...
n <- nPlot(data = df_4_6, value ~ Year, group = 'variable', color = 'variable', shape = 'variable', type = 'lineChart') 
n$chart(forceY = c(-.5, 3.5))
n$yAxis(axisLabel = 'Value of national capital (% national income)')
n$chart(margin = list(left = 100)) # margin makes room for label
n$yAxis(tickFormat = "#! function(d) {return Math.round(d*100*100)/100 + '%'} !#")
...
n <- nPlot(data = df_4_9, value ~ Year, group = 'variable', color = 'variable', shape = 'variable', type = 'lineChart') 
n$chart(forceY = c(-2, 4))
n$yAxis(axisLabel = 'Value of national capital (% national income)')
n$chart(margin = list(left = 100)) # make room in margins
n$yAxis(tickFormat = "#! function(d) {return Math.round(d*100*100)/100 + '%'} !#")
n$xAxis(axisLabel = 'Year')
...
n <- nPlot(data = df_4_10, value ~ Year, group = 'variable', color = 'variable', shape = 'variable', type = 'lineChart') 
n$chart(forceY = c(-.5, 3.5))
n$yAxis(axisLabel = 'Value of national capital (% national income)')
n$chart(margin = list(left = 100)) # make room in margins
n$yAxis(tickFormat = "#! function(d) {return Math.round(d*100*100)/100 + '%'} !#")

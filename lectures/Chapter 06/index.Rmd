...
n <- nPlot(data = df_6_1, value ~ Year, group = 'variable', color = 'variable', shape = 'variable', type = 'lineChart') 
...
n$xAxis(tickValues = "#! function (x) {    
    tickvalues = [1770, 1790, 1810, 1830, 1850, 1870, 1890, 1910, 1930, 1950, 1970, 1990, 2010];
    return tickvalues;
} !#")
...
n <- nPlot(data = df_6_2, value ~ Year, group = 'variable', color = 'variable', shape = 'variable', type = 'lineChart') 
n$chart(forceY = c(0, 1))
n$yAxis(axisLabel = 'Labor and capital income (% national income)')
n$chart(margin = list(left = 80)) 
n$yAxis(tickFormat = "#! function(d) {return Math.round(d*100*100)/100 + '%'} !#")
...
n <- nPlot(data = df_6_3, value ~ Year, group = 'variable', color = 'variable', shape = 'variable', type = 'lineChart') 
n$chart(forceY = c(.02, .12))
...
n <- nPlot(data = df_6_4, value ~ Year, group = 'variable', color = 'variable', shape = 'variable', type = 'lineChart') 
n$chart(forceY = c(.02, .12))
n$yAxis(axisLabel = 'Annual rate of return')
n$chart(margin = list(left = 80)) 
n$yAxis(tickFormat = "#! function(d) {return Math.round(d*100*100)/100 + '%'} !#")
...
n <- nPlot(data = df_6_5, value ~ Year, group = 'variable', color = 'variable', shape = 'variable', type = 'lineChart') 
n$chart(forceY = c(.12, .38))
...
n <- nPlot(data = df_6_6, value ~ Year, group = 'variable', color = 'variable', shape = 'variable', type = 'lineChart') 
n$chart(forceY = c(0, .45))
...
n <- nPlot(data = df_6_7, value ~ Year, group = 'variable', color = 'variable', shape = 'variable', type = 'lineChart') 
...
n <- nPlot(data = df_6_8, value ~ Year, group = 'variable', color = 'variable', shape = 'variable', type = 'lineChart') 
n$chart(forceY = c(0, .45))
n$yAxis(axisLabel = 'Profit share in value added')
n$chart(margin = list(left = 80)) 
n$yAxis(tickFormat = "#! function(d) {return Math.round(d*100*100)/100 + '%'} !#")

...
names(TSI.1) <- c("Year", "USA Top 10% Income Share")
...
names(TSI.2) <- c("Year", "Germany", "France", "United Kingdom")
...
# Figure S1.4a / TS1.7 / exchange rate euro/rupee
load("data/TS1.7.Rda")
df_S1_4a <- subset(TS1.7, variable %in% c("Year", "Euro/Rupee exchange rate", "Euro/Rupee purchasing power parity rate"))
row.names(df_S1_4a) <- NULL
save(df_S1_4a, file = "data/df_S1_4a.Rda")

# Figure S1.4b / TS1.7 / exchange rate euro/yen
load("data/TS1.7.Rda")
df_S1_4b <- subset(TS1.7, variable %in% c("Year", "Euro/Yen exchange rate", "Euro/Yen purchasing power parity rate"))
row.names(df_S1_4b) <- NULL
save(df_S1_4b, file = "data/df_S1_4b.Rda")

# Figure S1.5a / TS1.7 / exchange rate dollar/yuan
load("data/TS1.7.Rda")
df_S1_5a <- subset(TS1.7, variable %in% c("Year", "Dollar/Yuan exchange rate", "Dollar/Yuan purchasing power parity rate"))
row.names(df_S1_5a) <- NULL
save(df_S1_5a, file = "data/df_S1_5a.Rda")

# Figure S1.5b / TS1.7 / exchange rate dollar/rupee
load("data/TS1.7.Rda")
df_S1_5b <- subset(TS1.7, variable %in% c("Year", "Dollar/Rupee exchange rate", "Dollar/Rupee purchasing power parity rate"))
row.names(df_S1_5b) <- NULL
save(df_S1_5b, file = "data/df_S1_5b.Rda")

# Figure S1.5c / TS1.7 / exchange rate dollar/yen
load("data/TS1.7.Rda")
df_S1_5c <- subset(TS1.7, variable %in% c("Year", "Dollar/Yen exchange rate", "Dollar/Yen purchasing power parity rate"))
row.names(df_S1_5c) <- NULL
save(df_S1_5c, file = "data/df_S1_5c.Rda")
...
names(TS2.5) <- c("Period", "France", "Germany", "United States", "United Kingdom", "Seq")
...
# Figure 3.1 / / TS1 / United Kingdom / Capital
load("data/TS3.1.Rda")
...
# Figure 3.3 / TS3.1 / United Kingdom / Capital
load("data/TS3.1.Rda")
...
# Figure 3.5 / TS3.1 / United Kingdom / Capital
load("data/TS3.1.Rda")
...
names(TS4.4) <- c("Country", "National wealth", "Agricultural land", "Slaves", "Housing", "Other domestic capital", "Net foreign capital")
...
df_4_1$variable <- factor(df_4_1$variable)
...
df_4_2$variable <- factor(df_4_2$variable)
...
df_4_5$variable <- factor(df_4_5$variable)
...
df_4_6$variable <- factor(df_4_6$variable)
...
df_4_7$variable <- factor(df_4_7$variable)
...
df_4_8$variable <- factor(df_4_8$variable)
...
df_4_9$variable <- factor(df_4_9$variable)
...
df_4_10$variable <- factor(df_4_10$variable)
row.names(df_4_10) <- NULL
save(df_4_10, file = "data/df_4_10.Rda")

# Figure 4.11 / TS4.4 / United Kingdom France United States South & North / National capital
load("data/TS4.4.Rda")
df_4_11 <- TS4.4[which(TS4.4$variable %in% c("Agricultural land", "Housing", "Other domestic capital", "Net foreign capital", "Slaves")), ]
df_4_11$Country = factor(df_4_11$Country, levels = c("United Kingdom", "France", "United States (South)", "United States (North)"))
df_4_11$variable <- factor(df_4_11$variable)
...
# Spreadsheet TS5.6
TS5.6 <- read.xlsx("../Piketty2014FiguresTables/Chapter5TablesFigures.xlsx",
  sheetName = "TS5.6", rowIndex = 5:45, colIndex = 1:10, header = FALSE)
names(TS5.6) <- c("Year", "United States", "Japan", "Germany", "France", "United Kingdom", "Italy", "Canada", "Australia", "Spain")
save(TS5.6, file = "data/TS5.6.Rda")

# Spreadsheet TS5.7
TS5.7 <- read.xlsx("../Piketty2014FiguresTables/Chapter5TablesFigures.xlsx",
  sheetName = "TS5.7", rowIndex = 5:45, colIndex = 1:10, header = FALSE)
names(TS5.7) <- c("Year", "United States", "Japan", "Germany", "France", "United Kingdom", "Italy", "Canada", "Australia", "Spain")
save(TS5.7, file = "data/TS5.7.Rda")

# Spreadsheet TS5.8
TS5.8 <- read.xlsx("../Piketty2014FiguresTables/Chapter5TablesFigures.xlsx",
  sheetName = "TS5.8", rowIndex = 5:45, colIndex = 1:10, header = FALSE)
names(TS5.8) <- c("Year", "United States", "Japan", "Germany", "France", "United Kingdom", "Italy", "Canada", "Australia", "Spain")
save(TS5.8, file = "data/TS5.8.Rda")

# Spreadsheet TS5.9
TS5.9 <- read.xlsx("../Piketty2014FiguresTables/Chapter5TablesFigures.xlsx",
  sheetName = "TS5.9", rowIndex = 5:45, colIndex = 1:10, header = FALSE)
names(TS5.9) <- c("Year", "United States", "Japan", "Germany", "France", "United Kingdom", "Italy", "Canada", "Australia", "Spain")
save(TS5.9, file = "data/TS5.9.Rda")

# Spreadsheet TS5.10
TS5.10 <- read.xlsx("../Piketty2014FiguresTables/Chapter5TablesFigures.xlsx",
  sheetName = "TS5.10", rowIndex = 5:45, colIndex = 1:10, header = FALSE)
names(TS5.10) <- c("Year", "United States", "Japan", "Germany", "France", "United Kingdom", "Italy", "Canada", "Australia", "Spain")
save(TS5.10, file = "data/TS5.10.Rda")
...
df_5_6 <- df_5_6[!is.na(df_5_6$value), ] # remove NAs
...
# Figure 5.8 / CTS12.3 / world capital to income ratio
# Create factors Observed / Projected
...
### make data frames S5.7 to S5.11


# Figure S5.6 / TS5.5 + TS5.6 + TS5.7 / USA / Net foreign capital to income ratio
load("data/TS5.5.Rda")
df_S5_6a <- TS5.5[, c("Year", "United States")]
load("data/TS5.6.Rda")
df_S5_6b <- TS5.6[, c("Year", "United States")]
load("data/TS5.7.Rda")
df_S5_6c <- TS5.7[, c("Year", "United States")]
df_S5_6 <- Reduce(function(...)merge(..., by = "Year"), list(df_S5_6a, df_S5_6b, df_S5_6c))
names(df_S5_6) <- c("Year", "Net position (NFA)", "Foreign assets", "Foreign liabilities")
df_S5_6 <- melt(df_S5_6, id.vars = "Year")
save(df_S5_6, file = "data/df_S5_6.Rda")


# Figure S5.7 / TS5.5 / Japan / Net foreign capital to income ratio
load("data/TS5.5.Rda")
df_S5_7a <- TS5.5[, c("Year", "Japan")]
load("data/TS5.6.Rda")
df_S5_7b <- TS5.6[, c("Year", "Japan")]
load("data/TS5.7.Rda")
df_S5_7c <- TS5.7[, c("Year", "Japan")]
df_S5_7 <- Reduce(function(...)merge(..., by = "Year"), list(df_S5_7a, df_S5_7b, df_S5_7c))
names(df_S5_7) <- c("Year", "Net position (NFA)", "Foreign assets", "Foreign liabilities")
df_S5_7 <- melt(df_S5_7, id.vars = "Year")
save(df_S5_7, file = "data/df_S5_7.Rda")

# Figure S5.8 / TS5.5 / Germany / Net foreign capital to income ratio
load("data/TS5.5.Rda")
df_S5_8a <- TS5.5[, c("Year", "Germany")]
load("data/TS5.6.Rda")
df_S5_8b <- TS5.6[, c("Year", "Germany")]
load("data/TS5.7.Rda")
df_S5_8c <- TS5.7[, c("Year", "Germany")]
df_S5_8 <- Reduce(function(...)merge(..., by = "Year"), list(df_S5_8a, df_S5_8b, df_S5_8c))
names(df_S5_8) <- c("Year", "Net position (NFA)", "Foreign assets", "Foreign liabilities")
df_S5_8 <- melt(df_S5_8, id.vars = "Year")
save(df_S5_8, file = "data/df_S5_8.Rda")

# Figure S5.9 / TS5.5 / France / Net foreign capital to income ratio
load("data/TS5.5.Rda")
df_S5_9a <- TS5.5[, c("Year", "France")]
load("data/TS5.6.Rda")
df_S5_9b <- TS5.6[, c("Year", "France")]
load("data/TS5.7.Rda")
df_S5_9c <- TS5.7[, c("Year", "France")]
df_S5_9 <- Reduce(function(...)merge(..., by = "Year"), list(df_S5_9a, df_S5_9b, df_S5_9c))
names(df_S5_9) <- c("Year", "Net position (NFA)", "Foreign assets", "Foreign liabilities")
df_S5_9 <- melt(df_S5_9, id.vars = "Year")
save(df_S5_9, file = "data/df_S5_9.Rda")

# Figure S5.10 / TS5.5 / United Kingdom / Net foreign capital to income ratio
load("data/TS5.5.Rda")
df_S5_10a <- TS5.5[, c("Year", "United Kingdom")]
load("data/TS5.6.Rda")
df_S5_10b <- TS5.6[, c("Year", "United Kingdom")]
load("data/TS5.7.Rda")
df_S5_10c <- TS5.7[, c("Year", "United Kingdom")]
df_S5_10 <- Reduce(function(...)merge(..., by = "Year"), list(df_S5_10a, df_S5_10b, df_S5_10c))
names(df_S5_10) <- c("Year", "Net position (NFA)", "Foreign assets", "Foreign liabilities")
df_S5_10 <- melt(df_S5_10, id.vars = "Year")
save(df_S5_10, file = "data/df_S5_10.Rda")

# Figure S5.11 / TS5.5 / Spain / Net foreign capital to income ratio
load("data/TS5.5.Rda")
df_S5_11a <- TS5.5[, c("Year", "Spain")]
load("data/TS5.6.Rda")
df_S5_11b <- TS5.6[, c("Year", "Spain")]
load("data/TS5.7.Rda")
df_S5_11c <- TS5.7[, c("Year", "Spain")]
df_S5_11 <- Reduce(function(...)merge(..., by = "Year"), list(df_S5_11a, df_S5_11b, df_S5_11c))
names(df_S5_11) <- c("Year", "Net position (NFA)", "Foreign assets", "Foreign liabilities")
df_S5_11 <- na.omit(df_S5_11)  # remove NAs
df_S5_11 <- melt(df_S5_11, id.vars = "Year")
save(df_S5_11, file = "data/df_S5_11.Rda")
...
# Figure 6.3 / TS6.1 / rate of return / United Kingdom
load("data/TS6.1.Rda")
...
names(TS8.2) <- c("Year", "usa_top_10_is", "usa_top_10_5_is", "usa_top_5_1_is", "usa_top_1_is", "usa_top_01_is", "usa_top_10_is_wok", "usa_top_1_is_wok", "usa_top_01_is_wok", "usa_top_10_ws", "usa_top_1_ws")
  # is = income share with capital gains included
  # is_wok = without kapital gains
  # ws = wage share
...
load("data/TS8.1.Rda")
df_8_1 <- TS8.1[, c("Year", "france_top_10_is_wok", "france_top_10_ws")]
...
load("data/TS8.1.Rda")
df_8_2 <- TS8.1[, c("Year", "france_top_1_is_wok", "france_top_1_ws")]
names(df_8_2) <- c("Year", "Incomes", "Wages")
df_8_2 <- na.omit(df_8_2)  # remove NAs
...
df_8_6 <- na.omit(df_8_6)  # remove NAs
...
df_8_8 <- na.omit(df_8_8)  # remove NAs
...
names(TS9.4) <- c("Year", "Europe (Germany, France, United Kingdom, Sweden)", "Europe (Germany, France, United Kingdom)")
...
names(TS9.5) <- c("Year", "india_top_1_is_wok", "india_top_01_is_wok", "sa_top_1_is_wok", "sa_top_01_is_wok", "indonesia_top_1_is_wok", "indonesia_top_01_is_wok", "argentina_top_1_is_wok", "argentina_top_01_is_wok", "china_top_1_is_wok", "china_top_01_is_wok", "colombia_top_1_is_wok", "colombia_top_01_is_wok")
...
df <- df_9_1[which(df_9_1$Country == "France"), ]
df$value <- 1.2*df$value
df$variable <- "France (2013 dollars)"
df$Category <- "Hourly minimum wage"
df$Unit <- "2013 dollars"
df_9_1 <- rbind(df_9_1, df)
...
# Australia
df_9_2d <- data.frame(cbind(TS9.3$Year, TS9.3$australia_top_1_is))
...
# Sweden
df_9_3c <- data.frame(cbind(TS9.2$Year, TS9.2$sweden_top_1_is))
...
# Australia
df_9_5d <- data.frame(cbind(TS9.3$Year, TS9.3$australia_top_01_is))
...
# Sweden
df_9_6c <- data.frame(cbind(TS9.2$Year, TS9.2$sweden_top_01_is))
...
df_9_6b <- melt(df_9_6b, id.vars = c("Year", "Country", "Category"))
# Sweden
df_9_6c <- data.frame(cbind(TS9.2$Year, TS9.2$sweden_top_10_is))
...
load("data/TS9.4.Rda")
df_9_8a <- TS9.4[, c("Year", "Europe (Germany, France, United Kingdom, Sweden)")] 
# United States
load("data/TS8.2.Rda")
...
# India
load("data/TS9.5.Rda")
df_9_9a <- TS9.5[, c("Year", "india_top_1_is_wok")]
names(df_9_9a) <- c("Year", "India")
# South Africa
df_9_9b <- TS9.5[, c("Year", "sa_top_1_is_wok")]
names(df_9_9b) <- c("Year", "South Africa")
# Indonesia
df_9_9c <- TS9.5[, c("Year", "indonesia_top_1_is_wok")]
names(df_9_9c) <- c("Year", "Indonesia")
# Argentina
df_9_9d <- TS9.5[, c("Year", "argentina_top_1_is_wok")]
names(df_9_9d) <- c("Year", "Argentina")
# China
df_9_9e <- TS9.5[, c("Year", "china_top_1_is_wok")]
names(df_9_9e) <- c("Year", "China")
# Colombia
df_9_9f <- TS9.5[, c("Year", "colombia_top_1_is_wok")]
...
# Figure S9.1 / TS9.1 / minimum wage / France
load("data/TS9.1.Rda")
df_S9_1 <- subset(TS9.1, variable %in% c("Year", "France (current euros)", "France (2013 euros)"))
df_S9_1[df_S9_1$variable == "France (current euros)", ]$variable <- "Minimum wage in current euros"
df_S9_1[df_S9_1$variable == "France (2013 euros)", ]$variable <- "Minimum wage in 2013 euros"
save(df_S9_1, file = "data/df_S9_1.Rda")

# Figure S9.2 / TS9.1 / minimum wage / United States
load("data/TS9.1.Rda")
df_S9_2 <- subset(TS9.1, variable %in% c("Year", "United States (current dollars)", "United States (2013 dollars)"))
df_S9_2[df_S9_2$variable == "United States (current dollars)", ]$variable <- "Minimum wage in current dollars"
df_S9_2[df_S9_2$variable == "United States (2013 dollars)", ]$variable <- "Minimum wage in 2013 dollars"
save(df_S9_2, file = "data/df_S9_2.Rda")
...
# Figure 10.3S / TS10.1 / wealth inequality / United Kingdom
...
# Figure 10.3 / TS10.1 / wealth inequality / United Kingdom
...
df_11_5 <- na.omit(df_11_5)
df_11_5 <- melt(df_11_5, id.vars = "Year")
save(df_11_5, file = "data/df_11_5.Rda")

# Figure 11.5 / for use with rCharts
load("data/TS11.1a.Rda")
df_11_5_rc <- TS11.1a[, c("Year", "Ratio of average wealth at death to average wealth of the decedents and the living, (not including bequest gifts made before death)", "Ratio of average wealth at death to average wealth of the decedents and the living, (including bequest gifts made before death)")]
names(df_11_5_rc) <- c("Year", "Not including bequest gifts made before death", "Including bequest gifts made before death")
df_11_5_rc <- na.omit(df_11_5_rc)
df_11_5_rc <- melt(df_11_5_rc, id.vars = "Year")
save(df_11_5_rc, file = "data/df_11_5_rc.Rda")
...
df_11_6 <- na.omit(df_11_6)
save(df_11_6, file = "data/df_11_6.Rda")

# Figure 11.6 / for use with rCharts
load("data/TS11.1a.Rda")
df_11_6_rc <- TS11.1a[, c("Year", "Annual inheritance flow (% of national income) (economic flows)", "Simulated annual inheritance flow (scenario 1)", "Simulated annual inheritance flow (scenario 2)")]
names(df_11_6_rc) <- c("Year", "Observed series: Annual inheritance flow (% of national income)", "Simulated series: 2010-2100: g = 1.7% and r = 3.0%", "Simulated series: 2010-2100: g = 1.0% and r = 5.0%")
df_11_6_rc <- melt(df_11_6_rc, id.vars = "Year")
df_11_6_rc <- na.omit(df_11_6_rc)
save(df_11_6_rc, file = "data/df_11_6_rc.Rda")
...
df_11_7 <- na.omit(df_11_7)
save(df_11_7, file = "data/df_11_7.Rda")

# Figure 11.7 / for use with rCharts
load("data/TS11.2a.Rda")
df_11_7_rc <- TS11.2a[, c("Year", "Share of the capitalized inherited wealth (PPVR definition, estimate) (scenario 1)", "Share of the capitalized inherited wealth (PPVR definition, estimate) (scenario 2)")]
names(df_11_7_rc) <- c("Year", "Share of inherited wealth: 2010-2100: g = 1.7% and r = 3.0%", "Share of inherited wealth: 2010-2100: g = 1.0% and r = 5.0%")
df_11_7_rc <- melt(df_11_7_rc, id.vars = "Year")
# remove values prior to 2010
df_11_7_rc[df_11_7_rc$Year < 2010 & df_11_7_rc$variable == "Share of inherited wealth: 2010-2100: g = 1.0% and r = 5.0%", ]$value <- NA
df_11_7_rc <- na.omit(df_11_7_rc)
save(df_11_7_rc, file = "data/df_11_7_rc.Rda")
...
df_11_8 <- na.omit(df_11_8)
df_11_8 <- melt(df_11_8, id.vars = "Year")
save(df_11_8, file = "data/df_11_8.Rda")

# Figure 11.8 / for use with rCharts
load("data/TS11.1a.Rda")
df_11_8_rc <- TS11.1a[, c("Year", "Annual inheritance flow (% disposable income) (economic flows)", "Annual inheritance flow (% disposable income) (fiscal flows)")]
names(df_11_8_rc) <- c("Year", "Economic flows: computed from national wealth estimates, mortality tables, and age-wealth profiles", "Fiscal flows: computed from bequest and gift tax data, including tax-exempt assets")
df_11_8_rc <- na.omit(df_11_8_rc)
df_11_8_rc <- melt(df_11_8_rc, id.vars = "Year")
save(df_11_8_rc, file = "data/df_11_8_rc.Rda")
...
names(df_11_9) <- c("Year", "Inheritance share (% total lifetime resources)")
df_11_9 <- na.omit(df_11_9)
...
df_11_10 <- na.omit(df_11_10)
df_11_10 <- melt(df_11_10, id.vars = "Year")
save(df_11_10, file = "data/df_11_10.Rda")

# Figure 11.10 / for use with rCharts
load("data/TS11.1b.Rda")
df_11_10_rc <- TS11.1b[, c("Year", "Living standard attained by top 1% inheritors (% of bottom 50% labor earners lifetime resources) (scenario 1)", "Living standard attained by top 1% labor earners (% of bottom 50% labor earners lifetime resources) (scenario 1)")]
names(df_11_10_rc) <- c("Year", "Living standard attained by top 1% inheritors", "Multiples of living standard attained by the bottom 50% of labor earners, and as a function of year of birth")
df_11_10_rc <- na.omit(df_11_10_rc)
df_11_10_rc <- melt(df_11_10_rc, id.vars = "Year")
save(df_11_10_rc, file = "data/df_11_10_rc.Rda")
...
# Figure 12.2 / for use with rCharts
load("data/TS12.3.Rda")
df_12_2_rc <- TS12.3[, c("Year", "Total wealth of billionaires as a fraction of aggregate private wealth", "Number of billionaires per 100 million adults")]
names(df_12_2_rc) <- c("Year", "Total wealth of billionaires, as a fraction of aggregate private wealth", "Number of billionaires per 100 million adults")
df_12_2_rc <- melt(df_12_2_rc, id.vars = "Year")
save(df_12_2_rc, file = "data/df_12_2_rc.Rda")
...
# Figure 12.3 / for use with rCharts
load("data/TS12.3.Rda")
df_12_3_rc <- TS12.3[, c("Year", "Share of the top 1/20 million highest wealth holders in gobal private wealth", "Share of top 1/100 million highest wealth holders in gobal private wealth")]
names(df_12_3_rc) <- c("Year", "Wealth share of the top 1/20 million fractile", "Wealth share of the top 1/100 million fractile")
df_12_3_rc <- melt(df_12_3_rc, id.vars = "Year")
save(df_12_3_rc, file = "data/df_12_3_rc.Rda")

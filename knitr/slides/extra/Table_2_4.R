...
ggsave(p1, file = "figures/Figure_Table_2_4_France.pdf", width = 8, height = 5, dpi = 300)
ggsave(p1, file = "figures/Figure_Table_2_4_France.png", width = 8, height = 5)
...
# save as pdf, png
ggsave(p2, file = "figures/Figure_Table_2_4_UnitedStates.pdf", width = 8, height = 5, dpi = 300)
ggsave(p2, file = "figures/Figure_Table_2_4_UnitedStates.png", width = 8, height = 5)

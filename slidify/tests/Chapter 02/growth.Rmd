...
*** .hint
An annual growth rate of $g$ compounded $T$ times results in a total ('non-annual') **increase by a factor** of
$1 + G = (1 + g)^{T}$. 
...
$$
or, equivalently, a total growth rate of $170\%$

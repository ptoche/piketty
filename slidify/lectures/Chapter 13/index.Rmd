...
<figure class = "centered">  
<img src = "../../images/Umberto_D_Vittorio_de_Sica_1952.jpg" alt = "Umberto D by Vittorio de Sica (1952).">
...
- In pay-as-you-go (PAYG) pension systems, contributions are deducted from the wages of active workers and paid out as benefits to retirees. 
- In capitalized pension plans, contributions are invested and the returns used to finance benefit payments. 
- Most public pension systems are PAYG. 
- In PAYG, the rate of return is by definition equal to the growth rate of the economy: contributions rise at the same rate as average wages.

---

### The Future of Retirement

- When PAYG systems were introduced in the 1950s, growth rates were high &mdash; both demographic growth and productivity growth were high. 
- Today, the rate of wage growth is lower, but it is also more predictable, while the return on capital is very volatile.
- A transition from a capitalized system to PAYG would be problematic. 
- A difficulty of PAYG is that different rules apply to different professions. Governments need to establish a unified retirement scheme based on individual accounts with equal rights for everyone. 

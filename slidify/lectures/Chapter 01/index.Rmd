...
```{r 'Figure_S1_4a_rCharts',  message = FALSE, warning = FALSE, error = FALSE, echo = FALSE, tidy = FALSE, cache = FALSE}  
require(rCharts)
load("../../data/df_S1_4a.Rda") 
# round data for rChart tooltip display
df_S1_4a$value <- round(df_S1_4a$value, 2)
n <- nPlot(data = df_S1_4a, value ~ Year, group = 'variable', color = 'variable', shape = 'variable', type = 'lineChart') 
n$chart(forceY = c(0, 70))
n$yAxis(axisLabel = 'Exchange rate Euro/Rupee (in rupees)')
n$chart(margin = list(left = 80)) 
n$xAxis(axisLabel = NULL)
n$yAxis(tickFormat = "#! function(y) {return 'Rs' + y;} !#")
n$chart(useInteractiveGuideline = TRUE)
n$chart(color = colorPalette)
n$addParams(height = 450, width = 900)
n$setTemplate(afterScript = '<style>
...
n$save('figures/Figure_S1_4a.html', standalone = TRUE)
```
...
```{r 'Figure_S1_4b_rCharts',  message = FALSE, warning = FALSE, error = FALSE, echo = FALSE, tidy = FALSE, cache = FALSE}  
require(rCharts)
load("../../data/df_S1_4b.Rda") 
# round data for rChart tooltip display
df_S1_4b$value <- round(df_S1_4b$value, 2)
n <- nPlot(data = df_S1_4b, value ~ Year, group = 'variable', color = 'variable', shape = 'variable', type = 'lineChart') 
n$chart(forceY = c(90, 200))
n$yAxis(axisLabel = 'Exchange rate Euro/Yen (in yens)')
n$chart(margin = list(left = 80)) 
n$xAxis(axisLabel = NULL)
n$yAxis(tickFormat = "#! function(y) {return '¥' + y;} !#")
n$chart(useInteractiveGuideline = TRUE)
...
n$save('figures/Figure_S1_4b.html', standalone = TRUE)
```
...
```{r 'Figure_S1_5a_rCharts',  message = FALSE, warning = FALSE, error = FALSE, echo = FALSE, tidy = FALSE, cache = FALSE}  
require(rCharts)
load("../../data/df_S1_5a.Rda") 
# round data for rChart tooltip display
df_S1_5a$value <- round(df_S1_5a$value, 2)
n <- nPlot(data = df_S1_5a, value ~ Year, group = 'variable', color = 'variable', shape = 'variable', type = 'lineChart') 
n$chart(forceY = c(2, 9))
n$yAxis(axisLabel = 'Exchange rate Dollar/Yuan (in yuans)')
n$chart(margin = list(left = 80)) 
n$xAxis(axisLabel = NULL)
n$yAxis(tickFormat = "#! function(y) {return '¥' + y;} !#")
n$chart(useInteractiveGuideline = TRUE)
...
n$save('figures/Figure_S1_5a.html', standalone = TRUE)
```
...
```{r 'Figure_S1_5b_rCharts',  message = FALSE, warning = FALSE, error = FALSE, echo = FALSE, tidy = FALSE, cache = FALSE}  
require(rCharts)
load("../../data/df_S1_5b.Rda") 
# round data for rChart tooltip display
df_S1_5b$value <- round(df_S1_5b$value, 2)
n <- nPlot(data = df_S1_5b, value ~ Year, group = 'variable', color = 'variable', shape = 'variable', type = 'lineChart') 
n$chart(forceY = c(5, 55))
n$yAxis(axisLabel = 'Exchange rate Dollar/Rupee (in rupees)')
n$chart(margin = list(left = 80)) 
n$xAxis(axisLabel = NULL)
n$yAxis(tickFormat = "#! function(y) {return 'Rs' + y;} !#")
n$chart(useInteractiveGuideline = TRUE)
...
n$save('figures/Figure_S1_5b.html', standalone = TRUE)
```
...
```{r 'Figure_S1_5c_rCharts',  message = FALSE, warning = FALSE, error = FALSE, echo = FALSE, tidy = FALSE, cache = FALSE}  
require(rCharts)
load("../../data/df_S1_5c.Rda") 
# round data for rChart tooltip display
df_S1_5c$value <- round(df_S1_5c$value, 2)
n <- nPlot(data = df_S1_5c, value ~ Year, group = 'variable', color = 'variable', shape = 'variable', type = 'lineChart') 
n$chart(forceY = c(60, 200))
n$yAxis(axisLabel = 'Exchange rate Dollar/Yen (in yens)')
n$chart(margin = list(left = 80)) 
n$xAxis(axisLabel = NULL)
n$yAxis(tickFormat = "#! function(y) {return '¥' + y;} !#")
n$chart(useInteractiveGuideline = TRUE)
...
n$save('figures/Figure_S1_5c.html', standalone = TRUE)
```

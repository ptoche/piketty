...
n$yAxis(axisLabel = 'Private capital in years disposable household income')
n$chart(margin = list(left = 80)) 
n$yAxis(tickFormat = "#! function(d) {return Math.round(d*100*100)/100 + '%'} !#")
n$xAxis(axisLabel = NULL)
n$chart(useInteractiveGuideline = TRUE)
...
df_5_5$interaction <- interaction(df_5_5$variable, df_5_5$Category, sep = " ")
n <- nPlot(data = df_5_5, value ~ Year, group = 'interaction', type = 'lineChart')
n$chart(forceY = c(-1, 8))
n$yAxis(axisLabel = 'Value of capital (% national income)')
n$chart(margin = list(left = 80)) 
n$yAxis(tickFormat = "#! function(d) {return Math.round(d*100*100)/100 + '%'} !#")
...
n$chart(useInteractiveGuideline = TRUE)
n$chart(color = colorPalette)
n$addParams(height = 570, width = 900)
n$setTemplate(afterScript = '<style>
  .nv-point {
    stroke-opacity: 1!important;
    stroke-width: 5px!important;
...
df_5_7S$interaction <- interaction(df_5_7S$variable, df_5_7S$Category, sep = " ")
n <- nPlot(data = df_5_7S, value ~ Year, group = 'interaction', type = 'lineChart')
...
n$xAxis(tickValues = "#! function (x) {    
    tickvalues = [1880, 1900, 1920, 1940, 1960, 1980, 2000, 2020, 2040, 2060, 2080, 2100];
    return tickvalues;
} !#")
n$chart(useInteractiveGuideline = TRUE)
n$chart(color = colorPalette)
...
```{r 'Figure_S5_6_rCharts',  message = FALSE, warning = FALSE, error = FALSE, echo = FALSE, tidy = FALSE, cache = FALSE}  
require(rCharts)
load("../../data/df_S5_6.Rda") 
# round data for rChart tooltip display
df_S5_6$value <- round(df_S5_6$value, 2)
n <- nPlot(data = df_S5_6, value ~ Year, group = 'variable', color = 'variable', shape = 'variable', type = 'lineChart') 
n$chart(forceY = c(-.4, 1.4))
n$yAxis(axisLabel = 'Foreign assets and liabilities (% national income)')
n$chart(margin = list(left = 80)) 
n$yAxis(tickFormat = "#! function(d) {return Math.round(d*100*100)/100 + '%'} !#")
n$xAxis(axisLabel = NULL)
n$chart(useInteractiveGuideline = TRUE)
...
n$save('figures/Figure_S5_6.html', standalone = TRUE)
```
...
```{r 'Figure_S5_7_rCharts',  message = FALSE, warning = FALSE, error = FALSE, echo = FALSE, tidy = FALSE, cache = FALSE}  
require(rCharts)
load("../../data/df_S5_7.Rda") 
# round data for rChart tooltip display
df_S5_7$value <- round(df_S5_7$value, 2)
n <- nPlot(data = df_S5_7, value ~ Year, group = 'variable', color = 'variable', shape = 'variable', type = 'lineChart') 
n$chart(forceY = c(0, 1.6))
n$yAxis(axisLabel = 'Foreign assets and liabilities (% national income)')
n$chart(margin = list(left = 80)) 
n$yAxis(tickFormat = "#! function(d) {return Math.round(d*100*100)/100 + '%'} !#")
n$xAxis(axisLabel = NULL)
...
n$save('figures/Figure_S5_7.html', standalone = TRUE)
```
...
```{r 'Figure_S5_8_rCharts',  message = FALSE, warning = FALSE, error = FALSE, echo = FALSE, tidy = FALSE, cache = FALSE}  
require(rCharts)
load("../../data/df_S5_8.Rda") 
# round data for rChart tooltip display
df_S5_8$value <- round(df_S5_8$value, 2)
n <- nPlot(data = df_S5_8, value ~ Year, group = 'variable', color = 'variable', shape = 'variable', type = 'lineChart') 
n$chart(forceY = c(0, 3))
n$yAxis(axisLabel = 'Foreign assets and liabilities (% national income)')
n$chart(margin = list(left = 80)) 
n$yAxis(tickFormat = "#! function(d) {return Math.round(d*100*100)/100 + '%'} !#")
n$xAxis(axisLabel = NULL)
...
n$save('figures/Figure_S5_8.html', standalone = TRUE)
```
...
```{r 'Figure_S5_9_rCharts',  message = FALSE, warning = FALSE, error = FALSE, echo = FALSE, tidy = FALSE, cache = FALSE}  
require(rCharts)
load("../../data/df_S5_9.Rda") 
# round data for rChart tooltip display
df_S5_9$value <- round(df_S5_9$value, 2)
n <- nPlot(data = df_S5_9, value ~ Year, group = 'variable', color = 'variable', shape = 'variable', type = 'lineChart') 
n$chart(forceY = c(-.5, 3.5))
n$yAxis(axisLabel = 'Foreign assets and liabilities (% national income)')
n$chart(margin = list(left = 80)) 
n$yAxis(tickFormat = "#! function(d) {return Math.round(d*100*100)/100 + '%'} !#")
n$xAxis(axisLabel = NULL)
...
n$save('figures/Figure_S5_9.html', standalone = TRUE)
```
...
```{r 'Figure_S5_10_rCharts',  message = FALSE, warning = FALSE, error = FALSE, echo = FALSE, tidy = FALSE, cache = FALSE}  
require(rCharts)
load("../../data/df_S5_10.Rda") 
# round data for rChart tooltip display
df_S5_10$value <- round(df_S5_10$value, 2)
n <- nPlot(data = df_S5_10, value ~ Year, group = 'variable', color = 'variable', shape = 'variable', type = 'lineChart') 
...
n$save('figures/Figure_S5_10.html', standalone = TRUE)
```
...
```{r 'Figure_S5_11_rCharts',  message = FALSE, warning = FALSE, error = FALSE, echo = FALSE, tidy = FALSE, cache = FALSE}  
require(rCharts)
load("../../data/df_S5_11.Rda") 
# round data for rChart tooltip display
df_S5_11$value <- round(df_S5_11$value, 2)
n <- nPlot(data = df_S5_11, value ~ Year, group = 'variable', color = 'variable', shape = 'variable', type = 'lineChart') 
n$chart(forceY = c(-1.5, 3))
n$yAxis(axisLabel = 'Foreign assets and liabilities (% national income)')
n$chart(margin = list(left = 80)) 
n$yAxis(tickFormat = "#! function(d) {return Math.round(d*100*100)/100 + '%'} !#")
n$xAxis(axisLabel = NULL)
...
n$save('figures/Figure_S5_11.html', standalone = TRUE)
```

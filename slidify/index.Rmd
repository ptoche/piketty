...
<p style="border:3px; padding: 1em;">
...
This page contains material related to <b>Thomas Piketty</b>, <u>Capital in the 21st Century</u> (Harvard University Press, 2014). 
...
The project is <i>Open Source</i>. 
...
titles <- titles[1:17]  # select available chapters
links <- paste0("<br>", 
...
<a class="btn" href="start.html">Learn More &raquo;</a>
